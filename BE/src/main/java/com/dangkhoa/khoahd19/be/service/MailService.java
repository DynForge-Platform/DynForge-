    ...
    public void sendOtpEmail(String to, String otp, long validMinutes) {
        ...
        String html = """
                ...
                border:1px solid #e5e7eb;border-radius:12px">
                  <h2 style="color:#1e3acc;margin:0 0 8px">GRADORA</h2>
                  <p>Xin chào,</p>
                ...
                color:#1e3acc;margin:16px 0">%s</p>
                  ...
                  <p style="color:#6b7280;font-size:12px;margin-top:24px">GRADORA — Nền tảng kết nối
                  mentor học thuật.</p>
                </div>
        ...
        try {
            ...
            helper.setFrom(username, "GRADORA");
            helper.setTo(to);
            helper.setSubject("GRADORA - Mã OTP đặt lại mật khẩu: " + otp);
